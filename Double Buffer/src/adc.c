...
void adc_init()
{
	...
	ADC0_CFG1 |= ADC_CFG1_ADICLK(1) | ADC_CFG1_MODE_MASK | ADC_CFG1_ADIV_MASK;		// Bus/2 clock selected, 16-bit, clock/8(3MHz)
	...
	ADC0_SC3 |= ADC_SC3_ADCO_MASK | ADC_SC3_AVGE_MASK | ADC_SC3_AVGS_MASK;	// Continuous Conversion, Hardware avg
}
